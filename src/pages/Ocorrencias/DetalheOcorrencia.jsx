  ...
  return (
    <div style={{ padding: "28px 32px" }}>
      ...
      <div
        style={{
          background: "#0a1628",
          border: `1px solid ${severityColor[evento.severity]}30`,
          borderRadius: 16,
          overflow: "hidden",
          marginBottom: 20,
        }}
        ...
        >
          <div>
            <div style={{ display: "flex", gap: 8, marginBottom: 8 }}>
              ...
              <Tag color={severityColor[evento.severity]}>
                {severityLabel[evento.severity]}
              </Tag>
            </div>
            <h2
              style={{
            ...
            <div style={{ fontSize: 12, color: "#334155", marginTop: 6 }}>
              📅 {evento.date} · 📍 {evento.lat}, {evento.lng}
            </div>
          </div>
          <div
            style={{
              fontSize: 40,
              fontWeight: 900,
              color: severityColor[evento.severity],
          ...
          >
            ...
            >
              ...
              >
                ...
                <Marker longitude={evento.lng} latitude={evento.lat} anchor="center">
                  <div
                    style={{
                      width: 14,
                      height: 14,
                      borderRadius: "50%",
                      background: severityColor[evento.severity],
                      border: "2px solid #fff",
                      boxShadow: `0 0 8px ${severityColor[evento.severity]}`,
                    }}
                  />
                </Marker>
              </Map>
        ...
        {[
          ...
          <button
            ...
            style={{
              ...
              cursor: "pointer",
              color: aba === a.id ? "#ff3b3b" : "#475569",
              fontSize: 12,
              fontWeight: 700,
              borderBottom:
                aba === a.id ? "2px solid #ff3b3b" : "2px solid transparent",
              fontFamily: "monospace",
            }}
          >
            {a.label}
      ...
      {aba === "coleta" && (
        ...
        >
          {pontos.map((p) => (
            ...
            >
              <Tag color={p.type === "Fixo" ? "#0ea5e9" : "#8b5cf6"}>
                {p.type}
              </Tag>
              <div
                style={{
        ...
        >
          ...
          {voluntarios.map((v) => (
            ...
            >
              ...
              >
                {v.specialty.includes("Médic") ||
                v.specialty.includes("Enfer")
                  ? "⚕️"
