...
public class EventoGetDTO {
    ...
    public EventoGetDTO(Evento e) {
        ...
        this.date      = e.getDataInicio() != null
                           ? e.getDataInicio().format(DateTimeFormatter.ofPattern("dd/MM/yyyy"))
                           : null;
        this.dataFim   = e.getDataFim() != null
                           ? e.getDataFim().format(DateTimeFormatter.ofPattern("dd/MM/yyyy HH:mm"))
                           : null;
